...
func InitializeApp() (*App, error) {
	...
	boardUseCase := ProvideBoardUseCase(boardRepository, boardMemberRepository, workspaceRepository, workspaceMemberRepository, userRepository, columnRepository, cardRepository)
